...
class BankAccount {
    ...
    public function __construct(
        ...
        public string $accountType = self::SAVINGS
    )
    {
    ...
    private function isEligible($accountType, $balance): void {
        if( $accountType === self::SAVINGS && $balance < 500){
            echo "To create saving account min 500BDT needed.";
            exit;
        }

        if( $accountType === self::CURRENT && $balance < 1000){
    ...
    public function getAccountDetails(): string {
        ...
        Account Type: $this->accountType . PHP_EOL;
        ";
    }
